...
; (function ($) {
    ...
    Banner.prototype = {
        ...
        init: function (opts, ele) {
            // 参数判断;
            // 让 opt 一定为大于1项的数组;
            if (!(opts instanceof Object) || opts == undefined || typeof opts == "string") {
        ...
        moveTo: function (e) {
            ...
            switch (this.opts.movement_mode) {
                ...
                case "scrollLeft": this.scrollLeft(); break;
                case "scrollRight": this.scrollRight(); break;
            }
        },
        ...
        reset_ele: function () {
            ...
            var $li = $ul.find("li");
            var $width = $ele.width(); //当前元素的宽度
            var $height = $ele.height(); //当前元素的高度
            $ele.css({
                position: "relative",
                overflow: "hidden"
            })
            ...
            } else if (this.opts.movement_mode == "fade" || this.opts.movement_mode == "slide" || this.opts.movement_mode == "scrollLeft" || this.opts.movement_mode == "scrollRight") {
                $ul.width($width)
                $li.width($width)
                $li.css({
                    position: "absolute",
